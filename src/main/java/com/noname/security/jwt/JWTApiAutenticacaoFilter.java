...
public class JWTApiAutenticacaoFilter extends BasicAuthenticationFilter {

	private JWTTokenAuthenticService tokenService;
	private UserDetailsService userDetaisService;
	
	public JWTApiAutenticacaoFilter(AuthenticationManager gerenciadorAutenticacao, JWTTokenAuthenticService tokenService, UserDetailsService userDetaisService) {
